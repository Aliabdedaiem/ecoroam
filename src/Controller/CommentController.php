...
class CommentController extends AbstractController
{
    ...
    #[Route('/', name: 'app_comment_front_index', methods: ['GET'])]
    public function indexfront(CommentRepository $commentRepository): Response
    {
        return $this->render('comment/index_front.html.twig', [
            'comments' => $commentRepository->findAll(),
        ]);
    }
...
public function ajouter(Request $request, EntityManagerInterface $entityManager): Response
{
   ...
   #[Route('/ajouter', name: 'app_comment_create_new', methods: ['GET', 'POST'])]
    ...
    #[Route('/{id}/edit', name: 'app_comment_front_edit', methods: ['GET', 'POST'])]
    public function editfront(Request $request, Comment $comment, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->renderForm('comment/ajoutercom/_form.html.twig', [
            'comment' => $comment,
            'form' => $form,
        ]);
    }
